...
\$('#range a.active').trigger('click');
//--></script>
", "extension/opencart/admin/view/template/dashboard/chart_info.twig", "C:\\servidor_web\\loja_virtual\\upload\\extension\\opencart\\admin\\view\\template\\dashboard\\chart_info.twig");
    }
}
