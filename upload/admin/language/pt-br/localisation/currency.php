...
$_['text_iso']             = 'Você pode encontrar uma lista completa de códigos de moeda ISO e configurações <a href="http://www.xe.com/iso4217.php" target="_blank" class="alert-link">clicando aqui</a>.';
...
// Help
$_['help_code']            = 'Não altere se esta é a sua moeda padrão.';
$_['help_value']           = 'Preencha com 1.00 se for a moeda padrão.';

// Error
$_['error_permission']     = 'Atenção: Você não tem permissão para modificar as moedas.';
$_['error_extension']      = 'Atenção: A extensão de moeda não foi localizada.';
