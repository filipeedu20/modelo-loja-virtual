...
$_['text_no_results']    = 'Você ainda não fez solicitações de devolução.';
$_['text_agree']         = 'Eu li e concordo com o contrato de <a href="%s" class="modal-link"><b>%s</b></a>';
...
// Error
$_['text_error']         = 'A devolução não foi localizada.';
$_['error_token']        = 'Atenção: O token de devolução não é válido.';
...
$_['error_agree']        = 'Atenção: Você deve concordar o contrato de %s.';
